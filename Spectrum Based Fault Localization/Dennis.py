...
for i in range(0,len(x[0])):
	...
	try:
		...
		if ((nsuccess+nfailure)*(total_failed))!=0:
			fail_score=float(nfailure*(total_passed-nsuccess)-nsuccess*(total_failed-nfailure))/float(65*(nsuccess+nfailure)*(total_failed))
...
csvfile=open(str_cwd+"/Dennis.csv", "a+")
