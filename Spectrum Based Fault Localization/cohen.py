...
for i in range(0,len(x[0])):
	...
	try:
		...
		numerator=nfailure*(total_passed-nsuccess)-(total_failed-nfailure)*nsuccess
		denominator=((nfailure+nsuccess)*(total_passed)+total_failed*(total_failed-nfailure+ total_passed-nsuccess))
		if denominator!=0:
...
csvfile=open(str_cwd+"/cohen.csv", "a+")
