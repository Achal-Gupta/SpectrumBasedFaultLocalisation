...
for i in range(0,len(x[0])):
	...
	try:
		a = nfailure+nsuccess
		b = total_passed+total_failed-nsuccess-nfailure
		if (a*b*total_failed*total_passed)!=0:
			fail_score=float(nfailure+total_passed-nsuccess)/float(math.sqrt(a*b*total_failed*total_passed))
...
csvfile=open(str_cwd+"/Gower.csv", "a+")
