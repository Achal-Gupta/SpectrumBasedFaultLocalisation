...
for i in range(0,len(x[0])):
	...
	try:
		...
		numerator=4*(nfailure*(total_passed-nsuccess)-(total_failed-nfailure)*nsuccess)
		denominator=(2*nfailure+total_failed-nfailure+nsuccess)+(2*(total_passed-nsuccess)+total_failed-nfailure+nsuccess)
		if denominator!=0:
...
csvfile=open(str_cwd+"/fleiss.csv", "a+")
